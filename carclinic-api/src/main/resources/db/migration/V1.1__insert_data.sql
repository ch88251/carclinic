...
insert into staff (id, first_name, last_name, email, phone_number) values
(nextval('hibernate_sequence'), 'Alice', 'Davis', 'alice.davis@example.com', '303-555-6789'),
(nextval('hibernate_sequence'), 'Bob', 'Wilson', 'bob.wilson@example.com', '303-555-7890'),
(nextval('hibernate_sequence'), 'Carol', 'Miller', 'carol.miller@example.com', '303-555-8901'),
(nextval('hibernate_sequence'), 'David', 'Moore', 'david.moore@example.com', '303-555-9012'),
(nextval('hibernate_sequence'), 'Eve', 'Taylor', 'eve.taylor@example.com', '303-555-0123');
