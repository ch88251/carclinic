...
insert into owner (first_name, last_name, email, phone_number) values
('John', 'Doe', 'john.doe@example.com', '303-555-1234'),
('Jane', 'Smith', 'jane.smith@example.com', '303-555-2345'),
('Emily', 'Johnson', 'emily.johnson@example.com', '303-555-3456'),
('Michael', 'Williams', 'michael.williams@example.com', '303-555-4567'),
('Sarah', 'Brown', 'sarah.brown@example.com', '303-555-5678');